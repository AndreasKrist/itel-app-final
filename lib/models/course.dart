...
//BAYAR ------------------------------------------------------------------------------------------------------------------
    ...
    Course(
      ...
      description: 'This 5-day course focuses on installing, operating, configuring, and verifying a basic IPv4 and IPv6 network. It includes configuring a LAN switch, an IP router, connecting to a WAN, and identifying basic security threats. The course also covers the skills and knowledge necessary to install, operate, and troubleshoot a small to medium-sized branch office Enterprise ...',
      outline: null,
      prerequisites: null,
      whoShouldAttend: null,
      importantNotes: null,
    ...
    Course(
      ...
      description: 'Upon completion of the course, learners will be able to: Course Outline',
      outline: null,
      prerequisites: null,
      whoShouldAttend: null,
      importantNotes: null,
    ...
    Course(
      id: '1276',
      courseCode: 'BAP276',
      title: 'Business Analysis Professional (SF) (Synchronous E-Learning)',
      category: 'Business',
      certType: null,
      rating: 4.7,
      duration: '5 Days',
      ...
      startDate: 'April 21, 2025',
      nextAvailableDate: 'April 21, 2025',
      description: 'This 5-day, instructor-led course engages participants in using lab-intensive tools and methodologies to improve, manage, and create better projects that meet both customer and organizational expectations. Applying the methodologies from this course to a project helps bridge the gap between its outcomes and needs. This course also prepares participants to take the Certified Business Analysis ...',
      outline: null,
      prerequisites: null,
      whoShouldAttend: null,
      importantNotes: null,
