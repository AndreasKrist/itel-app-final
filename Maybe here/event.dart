...
class Event {
  ...
  final bool disableWorkingHours;
  ...
  Event({
    ...
    this.sharedAt,
    this.disableWorkingHours = false,
  });
  ...
  factory Event.fromFirestore(DocumentSnapshot doc) {
    ...
    return Event(
      ...
      isSharedToGlobalChat: data['isSharedToGlobalChat'] == true,
      sharedAt: data['sharedAt'] != null
          ? (data['sharedAt'] as Timestamp).toDate()
          : null,
      disableWorkingHours: data['disableWorkingHours'] == true,
    );
  }
  ...
  Event copyWith({
    ...
    return Event(
      ...
      disableWorkingHours: disableWorkingHours ?? this.disableWorkingHours,
    );
  }
}
